...
class InputConfig():
    def __init__(self):
        ...
        parser.add_argument('--batch_split', default=8, type=int)
        parser.add_argument('--test_batch_size', default=8, type=int)
        parser.add_argument('--writer_comment', default='', type=str)
        parser.add_argument('--s2s_weight', default=1, type=float)
        ...
        parser.add_argument('--vocab_path', default='datasets/vocab/persona_both_vocab.bin', type=str)
        parser.add_argument('--train_datasets', default='datasets/personachat/train_both_original.txt', type=str)
        parser.add_argument('--valid_datasets', default='datasets/personachat/valid_self_original.txt', type=str)
        parser.add_argument('--test_datasets', default='datasets/personachat/test_self_original.txt', type=str)
        parser.add_argument('--cache_vocab_path', default='datasets/vocab/cached_vocab.pickle', type=str)
        parser.add_argument('--train_datasets_cache', default='datasets/personachat/persona_train_seq2seq_both_cache', type=str)
        parser.add_argument('--valid_datasets_cache', default='datasets/personachat/persona_valid_seq2seq_cache', type=str)
        parser.add_argument('--test_datasets_cache', default='datasets/personachat/persona_test_seq2seq_cache', type=str)
        ...
        parser.add_argument('--mixup_cache', default='datasets/personachat/mixup_cache_seq2seq_th0.4', type=str)
        ...
        parser.add_argument('--mixup_model_path', default='./fasttext_model/persona_50_cbow.bin', type=str)
        ...
        parser.add_argument('--max_history_size', type=int, default=5, help='max history size in input ids')
        ...
        parser.add_argument('--model_type', type=str, default='seq2seq', help='se2seq=seq2seq using Transformer, '
